 ...
 \item \textbf{Gram Matrix Extraction:} Extract style correlations from ResNet-50 intermediate layers
      ...
      \footnotesize{
        \begin{itemize}
          ...
          \item $\text{Adapter}$: bottleneck MLP ($768 \rightarrow 64\text{-}256 \rightarrow 512$ dimensions)
          \item $\alpha \cdot (\cdot) + \Fv$: residual connection preserves original CLIP semantics
        \end{itemize}
        }
  \end{itemize}
\end{frame}
