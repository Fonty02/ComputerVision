...
\frametitle{Background: TIMO (Text-Image Mutual Guidance Optimization)}
 \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth ,height=0.5\textheight]{../img/TIMO.png}
      \caption{TIMO Architecture Overview}
    \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Two Main Branches}
      \textbf{Text-Guided Image (TGI):} Uses textual representations to refine and guide visual features
      
      \textbf{Image-Guided Text (IGT):} Finds optimal weights for textual prompts using support visual features, dynamically adapting textual descriptions to image
  \end{block}
...
\begin{frame}
    ...
    \begin{itemize}
        \item T-tests confirmed the significance of performance differences.
...
\begin{frame}
  ...
  \begin{itemize}
    \item This work was proposed by PhD student \textbf{Nicola Fanelli} and \textbf{Prof. Giovanna Castellano} at the University of Bar
