  ...
  \begin{block}{Meta-Learning Training for StyCLIP}
    \begin{itemize}
      ...
      \item Two StyCLIP training configurations:
        \begin{itemize}
          \item \textbf{StyCLIP FSL1}: Trained with K=1 support shot.
          \item \textbf{StyCLIP FSL4}: Trained with K=4 support shots.
        \end{itemize}
    \end{itemize}
  \end{block}
  ...
  \begin{column}{0.5\textwidth}
    \begin{block}{Backbones Compared}
      \begin{itemize}
        ...
        \item \textbf{StyCLIP FSL1}: Our custom backbone, trained with 1-shot.
        \item \textbf{StyCLIP FSL4}: Our custom backbone, trained with 4-shots.
      \end{itemize}
    \end{block}
  \end{column}
  \end{columns}
