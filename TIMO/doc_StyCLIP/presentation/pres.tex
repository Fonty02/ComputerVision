...
\begin{frame}
  ...
  Extends standard CLIP (RN50 backbone) by integrating explicit style representations.
  \begin{figure}
    \includegraphics[width=0.9\linewidth,height=0.8\textheight]{../img/diagram.png} % Adjust path if needed
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=0.8\linewidth]{../img/episode_results.png} % Adjust path if needed
    \caption{Example episode for CLIP RN50 backbone}
  \end{figure}
  \begin{itemize}
    \item N=2 artists, K=2 support examples, Q=1 query examples.
  \end{itemize}
  \end{frame}
